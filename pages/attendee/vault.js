...
import StorePrizes from "/components/moonstone/user/vault/store/Prizes";
import WheelEmpty from "/components/moonstone/user/vault/wheel/Empty";
import WheelPrizes from "/components/moonstone/user/vault/wheel/Prizes";
...
function Vault() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-5">
        <button
          className={`font-iregular bg-${tab ? "quinary" : "white"
        ...
        <button
          className={`font-iregular bg-${tab ? "white" : "quinary"
